{% macro sync_to_master_hub(master_model_id) %}
    ...
    {%- set query -%}
        ...
        WHEN NOT MATCHED THEN
            INSERT (tenant_slug, tenant_skey, source_platform, source_schema_hash, source_schema, raw_data_payload, loaded_at)
            VALUES (source.tenant_slug, source.tenant_skey, source.source_platform, source.source_schema_hash, source.source_schema, source.raw_data_payload, current_timestamp)
    {%- endset -%}
