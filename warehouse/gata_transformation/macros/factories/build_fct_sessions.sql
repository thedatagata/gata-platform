...
{%- else -%}
    SELECT
        ...
        CAST(NULL AS BIGINT)    AS funnel_max_step,
        CAST(NULL AS BIGINT)    AS funnel_step_1_session_start,
        CAST(NULL AS BIGINT)    AS funnel_step_2_view_item,
        CAST(NULL AS BIGINT)    AS funnel_step_3_add_to_cart,
        CAST(NULL AS BIGINT)    AS funnel_step_4_begin_checkout,
        CAST(NULL AS BIGINT)    AS funnel_step_5_add_payment_info,
        CAST(NULL AS BIGINT)    AS funnel_step_6_purchase,
        CAST(NULL AS BIGINT)    AS funnel_conversion_count,
